...
var numberOfLoops = 0;
var ANSWER_COUNT = 3; // number of possible answers
var GAME_LENGTH = 1;  // The number of questions per  game.
var GAME_STATES = {
    TRIVIA: "_TRIVIAMODE", // Asking trivia questions.
    START: "_STARTMODE", // Entry point, start the skill.
...
var languageString = {
    "en": {
        "translation": {
            ...
            "CANCEL_MESSAGE": "Ok, let\'s learn again soon.",
            "NO_MESSAGE": "Ok, we\'ll learn another time. Goodbye!",
            "TRIVIA_UNHANDLED": "Try saying a number between 1 and %s",
            "HELP_UNHANDLED": "Say yes to continue, or no to end the game.",
            "START_UNHANDLED": "Say start to start a new game.",
            "NEW_GAME_MESSAGE": "Welcome to %s. ",
            "WELCOME_MESSAGE": "I will ask you a question, try to get it right! " +
            "Just say the letter of the answer. Let\'s begin. ",
            "ANSWER_CORRECT_MESSAGE": "correct. ",
            "ANSWER_WRONG_MESSAGE": "wrong. ",
            "CORRECT_ANSWER_MESSAGE": "The correct answer is %s: %s. ",
            "ANSWER_IS_MESSAGE": "That answer is ",
            "TELL_QUESTION_MESSAGE": "Question %s. %s ",
            "GAME_OVER_MESSAGE": "Thank you for learning!",
            "SCORE_IS_MESSAGE": "",
            "HINT1": "Try converting to like terms. Remember we want to add the numerators not the denominators. ",
            "HINT2": "Think about it like this. If you have half a pie and your friend gives you one fourth of a pie, how much pie do you have?"
        }
    },
    "en-US": {
        "translation": {
...
var startStateHandlers = Alexa.CreateStateHandler(GAME_STATES.START, {
    "StartGame": function (newGame) {
        ...
        const alphaIndex = ["<say-as interpret-as=\"spell-out\">A</say-as>","<say-as interpret-as=\"spell-out\">B</say-as>","<say-as interpret-as=\"spell-out\">C</say-as>"];

        for (var i = 0; i < ANSWER_COUNT; i++) {
            repromptText += /*(i+1).toString()*/ alphaIndex[i] + ". " + roundAnswers[i] + ". ";
        }
...
function handleUserGuess(userGaveUp) {
    ...
    while(parseInt(this.event.request.intent.slots.Answer.value) != this.attributes["correctAnswerIndex"]){
        if (numberOfLoops == 0){
            //numberOfLoops = numberOfLoops + 1;
            speechOutputAnalysis = this.t("ANSWER_WRONG_MESSAGE");
            speechOutputAnalysis += this.t("HINT1");
        } else{
            speechOutputAnalysis = this.t("ANSWER_WRONG_MESSAGE");
            speechOutputAnalysis += this.t("HINT2");
            //change
            numberOfLoops = 0;
        }
        ...
        const alphaIndex = ["<say-as interpret-as=\"spell-out\">A</say-as>","<say-as interpret-as=\"spell-out\">B</say-as>","<say-as interpret-as=\"spell-out\">C</say-as>"];
        for (var i = 0; i < ANSWER_COUNT; i++) {
            repromptText += alphaIndex[i] + ". " + roundAnswers[i] + ". ";
        }
...
function populateGameQuestions(translatedQuestions) {
    ...
    var gameQuestions = [];
    var indexList = [];
    var index = translatedQuestions.length - 1;
